...
public class MoveAgent : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            //NavMeshAgent 가가야 할 방향 벡터를 쿼터니언 타입의 각도로 변환
            Quaternion rot = Quaternion.LookRotation(agent.desiredVelocity);        //NavMeshAgent가 이동할 때 desiredVelocity 는 다음 목적지로 향하는 속도
